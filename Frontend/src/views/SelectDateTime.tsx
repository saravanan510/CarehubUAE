        ...
        <Row>
              ...
              <DatePicker
                ...
                customInput={
                  <div className="custom-datepicker">
                    ...
                    <input type="text" readOnly value={date ? date.toLocaleDateString() : ""} />
                  </div>
                }
              />
            </div>
          ...
          <div style={{ marginTop: "20px" }}>
            ...
            <button className="custom-button-secondary">
              <Link href={"/book-blood-test"}>Cancel</Link>
            </button>
          </div>
          {error && (
            <p style={{ color: "red", marginTop: "10px" }}>Choose Appointment Date and Time</p>
          )}
        </Row>
      </Container>
    </section>
